...
export function CardCampaignReceived({ campaign }: CardCampaignReceivedProps) {
  ...
  return (
    <div className="flex w-full flex-col bg-other-card rounded-lg shadow-md">
      <div className="flex w-full px-6 py-8 items-center">
        ...
        <div className="flex items-center justify-center w-14 h-14 bg-other-border rounded-md text-2xl mr-6">👌</div>
